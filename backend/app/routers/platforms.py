...
def create_platform(
    ...
    # Automatically commit the initial version
    ...
    commit_version(
        ...
        snapshot=snapshot,
        change_summary="Initial platform creation",
        created_by=user.id,
    )
...
def export_platform_xml(
    ...
    """Exports the platform and its components to an XML-compatible ZIP archive."""
    platform = _get_platform_or_404(db, platform_id)
